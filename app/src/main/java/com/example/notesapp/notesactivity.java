    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteAdapter = new FirestoreRecyclerAdapter<firebasemodel, NoteViewHolder>(allusernotes) {
            ...
            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, int position, @NonNull firebasemodel firebasemodel) {
                ...
                ImageView popupbutton = noteViewHolder.itemView.findViewById(R.id.menupopbuttom);
                LinearLayout note = noteViewHolder.itemView.findViewById(R.id.note);
